...
import (
	...
	"github.com/stretchr/testify/suite" // lib externa que cria o suit pra test
...
//SetupSuite => roda antes de executar um test
...
//TearDownTest => roda depois que terminar um test
